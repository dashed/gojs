...
define(["underscore", "jquery", "Chain"], function(_, $, Chain) {
  ...
  _Board = (function() {
    ...
    _Board.prototype.get_neighbors = function(_point) {
    ...
    _Board.prototype.get_color = function(_virtual_board, point) {
      var n_x, n_y;
      n_x = point[0];
      n_y = point[1];
    ...
    _Board.prototype.set_color = function(_virtual_board, point, _color) {
      var n_x, n_y;
      n_x = point[0];
      n_y = point[1];
    ...
    _Board.prototype.get_opposite_color = function(_color) {
      var _color_opp;
    ...
    _Board.prototype.get_chain_points = function(_virtual_board, point) {
    ...
    _Board.prototype.get_chain = function(_virtual_board, point) {
