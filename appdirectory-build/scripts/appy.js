...
define(["raphael", "jquery", "underscore", "Chain", "Board", "domReady!"], function(Raphael, $, _, Chain, Board) {
  ...
  _.each(_.range(n - 1), function(letter, index) {
  ...
  _.each(_.range(1, n), function(letter, index) {
  ...
  white_stone = function(i, j) {
    ...
    return circle.attr("stroke-width", "1.1");
  };
  black_stone = function(i, j) {
    ...
    return circle.attr("stroke-width", "1.2");
  };
